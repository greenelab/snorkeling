...
base_dir = os.path.join(os.path.dirname(os.getcwd()), 'disease_gene')
...
dag_map_df.to_csv(os.path.join(base_dir, "disease_associates_gene/disease_associates_gene.tsv.xz"),
                  compression='xz', sep="\t", index=False, float_format='%.5g')
...
dug_map_df.to_csv(os.path.join(base_dir, "disease_upregulates_gene.tsv.xz"),
                  compression='xz', sep="\t", index=False, float_format='%.5g')
...
ddg_map_df.to_csv(os.path.join(base_dir, "disease_downregulates_gene.tsv.xz"),
                  compression='xz', sep="\t", index=False, float_format='%.5g')
