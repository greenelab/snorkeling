...
get_ipython().magic(u'time lstm.train(train_cands, train_sentences_df.label.values, **train_kwargs)')
...
tpr, fpr, _ = roc_curve(dev_sentences_df.curated_dsh.values, dev_marginals)
auc(fpr, tpr)
...
precision, recall, _ = precision_recall_curve(dev_sentences_df.curated_dsh.values, dev_marginals)
