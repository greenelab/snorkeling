...
entity_level_df = pd.read_table("../datafile/results/gene_interacts_gene.tsv.xz")
...
total_candidates_df.to_csv("results/all_gig_candidates.tsv.xz", compression="xz", index=False, sep="\t")
